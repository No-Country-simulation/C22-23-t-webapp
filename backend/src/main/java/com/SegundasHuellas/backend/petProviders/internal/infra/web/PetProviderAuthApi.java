...
public interface PetProviderAuthApi {
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            schema = @Schema(implementation = PetProviderDetailResponse.class)
                    )
            ),
            @ApiResponse(
                    responseCode = "400",
    ...
    public PetProviderDetailResponse register (@RequestBody @Valid PetProviderRegistrationRequest request);
    ...
    @GetMapping("/{userId}")
    public PetProviderDetailResponse getPetProviderDetails(Long id);
